 ...
 * @author dongyueli
 */
public class ConfigureAe {
    
    public static Ecoe configureABusiness() {
         
        Ecoe ecoe = Ecoe.getInstance();
        ...
        //set e admin
        Employee employee = ecoe.getEmployeeDirectory().createEmployee("LDY");
        UserAccount ua = ecoe.getUserAccountDirectory().createUserAccount("aa", "aa", employee, new eAdminRole());

        //set network1
        Network n1 = ecoe.createAndAddNetwork();
        ...
        //set network2
        Network n2 = ecoe.createAndAddNetwork();
